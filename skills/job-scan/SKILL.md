...
`greenhouse.md`, `lever.md`, `ashby.md`, `workable.md`, `teamtailor.md`, `swissdevjobs.md`, `taleez.md`, `flatchr.md`, `digitalrecruiters.md`, `talentsoft.md`, `emploi-territorial.md`, `labonnealternance.md`) are plain HTTP and need no extension,
no login and no Chrome. Only `linkedin.md`, `jobup.md`, `jobs-ch.md`,
`indeed.md`, `cadremploi.md`, `figaro-emploi.md` and `softy.md` need the user's own browser — and of those,
