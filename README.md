...
| **fachkraft.ch / sta.jobs** | yes | no | Swiss trades and industry, through a staffing agency. **No browser**, and the whole board — around 3 500 ads — arrives in one request. The employer is **never named**, as on any agency board |
