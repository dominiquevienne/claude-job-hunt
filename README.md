...
- **`job-scan`** — sweeps the job boards you switch on, in *your own* Chrome,
  ...
  no browser needed), **job-room.ch**, **France Travail** and **Empléate**
  (the Swiss, French and Spanish public employment services, no browser either), **Workday / Greenhouse / Lever / Ashby** (your target
