...
| fachkraft.ch / sta.jobs | Nothing — **no login, no browser.** Swiss trades and industry. **Offer only ONE of the two domains**: they are the same board, and sweeping both records every ad twice unless the portable reference is fetched. Warn them the employer is never named |
