# Board measurement — IranTalent (`www.irantalent.com`, Iran): «Recruitment & Jobs for Professionals», one of the oldest Iranian boards; the root served to the declared client (646 KB) with no count stated, rules open; no adapter yet
...
<!-- script: none -->
<!-- countries: IR -->
<!-- content: measured · **the root (200, 646 779 / 646 956 B, md5 307803252231 / 3963b0a12ba6) is an English-titled front with no count stated and no JobPosting; `_robots.allowed('www.irantalent.com','/')` → open, certain; the list and the ad not read** · 2026-09-17 -->
