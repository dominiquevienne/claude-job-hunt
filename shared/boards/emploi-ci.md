# Board adapter — Emploi.ci (Côte d'Ivoire): reopened by the 2026-09-07 doctrine, and the transport refuses the client with a static 403
...
**Measured 2026-09-12 at 10:54:52Z UTC for #233, lot 2 — a measurement of the
...
```
GET https://www.emploi.ci/                                403, 25 B, md5 9ccabba20b9f    (10:54:52Z)
GET https://www.emploi.ci/                                403, 25 B, md5 9ccabba20b9f    (second fetch)
GET https://www.emploi.ci/recherche-jobs-cote-ivoire     403, 25 B, md5 9ccabba20b9f    (10:55:51Z)
GET https://www.emploi.ci/recherche-jobs-cote-ivoire     403, 25 B, md5 9ccabba20b9f    (second fetch)
```
