...
| ACBAR Jobs (Afghanistan) | `acbar.md` | **Measured 2026-09-17 (#613), no script yet: the NGO coordination body's job list served (88 KB, identical twice), rules open, «260 jobs» stated, employer pages (IOM, UNOPS, DACAAR announce there) — the historic first Afghan portal.** | — |
...
| Syria Jobs Network (Syria) | `jobsyria.md` | **Measured 2026-09-17 (#608), no script yet: the root served (844 KB, identical twice), rules open, «+6356 فرصة» stated with category counts, the newest NGO ads on the front, the list at `/jobs/list`.** | — |
| Wazefni Syria (Syria) | `wazefnisy.md` | **Measured 2026-09-17 (#608), no script yet: `/jobs/` served (95 KB, identical twice), rules open, an older PHP board, no count stated.** | — |
...
| HireLebanese (Lebanon) | `hirelebanese.md` | **Measured 2026-09-17 (#609), no script yet: an ASP.NET WebForms board — the search page served (52 KB, identical twice), rules open, the search a POST with a ViewState; «Browse Jobs» is the route to measure.** | — |
...
| Yemen HR (Yemen) | `yemenhr.md` | **Measured 2026-09-17 (#607), no script yet: `/jobs/` served as a table (752 KB), rules open, «Search Total: 51» with category and location counts, «1 of 2 pages», ads at `/jobs/<slug>-<id>` — jobs and tenders, NGO and private.** | — |
| Yemen Young Platform (Yemen) | `yemenyp.md` | **Measured 2026-09-17 (#607), no script yet: `/jobs` is an 8 KB shell to the declared client, rules open — client-rendered; the list route is the adapter's first line.** | — |
...
| BLMIS — Labour Market Information System (Bhutan) | `blmis.md` | **Measured 2026-09-17 (#605), no script yet: the Ministry's public employment service served (a Livewire app, the jobseeker page 2.4 MB), rules open — its list arrives by Livewire calls; the route to measure.** | — |
...
| Government of Timor-Leste — Recruitment (Timor-Leste) | `timor-leste-gov-recruitment.md` | **Measured 2026-09-18 (#612), no script yet: the Government portal's WordPress recruitment category served (33 KB), four posts on the day, rules open; the tenderwell app it uses answers 404 at its root.** | — |
...
| JobCentre Brunei (Brunei) | `jobcentrebrunei.md` | **Measured 2026-09-18 (#611), no script yet: the public employment service's search served (409 KB), rules open, «Showing 1 to 12 of 579 entries», a Liferay pager, `/web/guest/view-job/-/jobs/<id>/<slug>` ads.** | — |
...
| PEPE — IEFP Cabo Verde (Cabo Verde) | `pepe-iefp.md` | **Measured 2026-09-18 (#614): the public employment institute's platform is served, its vacancies behind a candidate account — no public list found; `iefp.cv/empregos/` is institutional.** The issue says what blocks | — |
...
| Mauritius Jobs — National Employment Department (Mauritius) | `mauritiusjobs.md` | **Measured 2026-09-18 (#618), no script yet: the public portal served (130 KB), «650 Jobs» stated, `/jobsearch`; rules unreadable (no rules, certain False).** | — |
...
| Department of Public Information — government vacancies (Guyana) | `dpi-gov-gy.md` | **Measured 2026-09-18 (#621), no script yet: the Government's «Vacancies» category served (312 KB), 7 notices on page 1, newest 2026-09-15, rules open, no count stated.** | — |
...
| Government of Saint Lucia — job opportunities and vacancies (Saint Lucia) | `govt-lc.md` | **Indeterminate 2026-09-18 (#619): `/jobs` and `/vacancies` answer 500 (an ASP.NET database error) to the client and to curl while the root is served; control 2026-09-21.** | — |
...
| Ministry of Employment — National Vacancies (Seychelles) | `employment-gov-sc.md` | **Measured 2026-09-18 (#617), no script yet: the public employment service publishes one weekly PDF (387 KB, 15–21 September), no HTML list; page served, rules open.** | — |
...
| KKTC Çalışma Dairesi — Labour Department (Northern Cyprus) | `calisma-gov-ct-tr.md` | **Measured 2026-09-18 (#606), no script yet: served over plain HTTP only (https fails TLS to every client), a DotNetNuke portal of forms, no vacancy list on its front.** | — |
...
| Government of Antigua and Barbuda — vacancies (Antigua and Barbuda) | `ab-gov-ag.md` | **Measured 2026-09-18 (#620), no script yet: the Government's vacancies page served (13 KB), two PDF vacancies both past their deadline, rules open.** | — |
...
| Service Commissions Department — public-service vacancies (Saint Vincent and the Grenadines) | `psc-gov-vc.md` | **Measured 2026-09-18 (#616), no script yet: the Public Service Commission's vacancies page served (21 KB), two open posts with deadlines and PDFs, rules open.** | — |
...
| Ministry of Labour job search — shoghl.mcls.gov.ir (Iran) | `shoghl-mcls.md` | **Measured 2026-09-17 (#600), no script: the public employment service's «سامانه جستجوی شغل» resolves on two public resolvers and times out twice to the declared client; the older `karyabi.mcls.gov.ir` is NXDOMAIN on both.** INDÉTERMINÉ — a tab and a later reading decide; nothing was served | — |
| Jobvision (Iran) | `jobvision.md` | **Measured 2026-09-17 (#600), no script yet: the root served (355 KB), rules open, «56,781 آگهی» stated — the largest Iranian generalist by its own count.** The list, the pager and the ad are the adapter's first line (its `adapter` issue) | — |
...
| Karboom (Iran) | `karboom.md` | **Measured 2026-09-17 (#600), no script yet: the root served (104 KB), rules open, no count stated.** | — |
| Iran Estekhdam (Iran) | `iranestekhdam.md` | **Measured 2026-09-17 (#600), no script yet: the root served (136 KB), rules open — an employment-news front (banks', ministries' and companies' calls), no count stated.** | — |
...
| Myanmar National Portal — Jobs & Vacancies (Myanmar) | `myanmar-gov-vacancies.md` | **Measured 2026-09-17 (#601), no script yet: `myanmar.gov.mm/vacancies` served (222 KB, Liferay), the government's vacancy notices with per-ministry facets, rules open, no count stated.** The public entry while the LEO system is unreachable | — |
| JobNet (Myanmar) | `jobnet-mm.md` | **Measured 2026-09-17 (#601), no script yet: the root served (200 KB), rules open, industry and function facets, no count stated — «Myanmar no.1» by its own claim.** | — |
...
| Public Service Commission (Kenya) | `publicservice-go-ke.md` | **Served on 2026-09-20 after two mute days (#283 remeasured).** Cloudflare's managed rules open the `*` group (`ClaudeBot` refused, `Claude-User` not named); vacancies on the WebForms subsite `pscims.publicservice.go.ke` — 1 active advert, 16 advert PDFs on `/jobs/`. No script; adapter issue #802 |
...
| National Job Bank (Guyana) | `jobs-gov-gy.md` | **Measured, no adapter yet (#314): the Ministry of Labour's free national board, served to the declared client on 2026-09-21** — the list is behind the form its own «See all jobs» button submits (`POST job_search.php action=search`): **«187 Jobs Found»**, pager «of 10», 2 564 all time; cards with title, employer, region, type, salary in GYD, posting and closing dates; no JobPosting; found behind `labour-gov-gy.md` |
