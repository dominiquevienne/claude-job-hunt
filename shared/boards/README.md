...
| UKG Pro (ex-UltiPro) | `ukgpro.md` | **Measured 2026-09-20 (#463), no route: the tenant's board page is permitted and served, but the list it loads (`JobBoardView/LoadSearchResults`) is refused in writing to `*` — no route crosses a written refusal; the owner decides (`override_robots` or exclusion), ticket adapter+blocked #792.** | — |
