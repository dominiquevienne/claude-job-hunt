...
| PaperPk (Pakistan) | `paperpk.md` | **Measured, no script (#323): the rules file 403, the declared client gets a Cloudflare challenge — never defeated** | **2026-09-14 10:42 UTC: «Sorry, you have been blocked» to a real browser too — a block page, not a challenge (borne 0); `route: none` stands, the owner's word to give** |
